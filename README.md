...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/long-cake-3131
```

A live public deployment of this template is available at [https://long-cake-3131.templates.workers.dev](https://long-cake-3131.templates.workers.dev)
